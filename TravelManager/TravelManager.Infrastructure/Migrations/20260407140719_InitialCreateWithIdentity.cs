    ...
    public partial class InitialCreateWithIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "role-user", "cs-role-user", "User", "USER" }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "temporary-user-id", 0, "static-concurrency-stamp", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "test@travel.com", true, false, null, "TEST@TRAVEL.COM", "TEST@TRAVEL.COM", null, null, false, "static-security-stamp", false, "test@travel.com" });
        }
    }
}
